...
|---|---|---|---|---|
| MONAI | AI Toolkit for Healthcare Imaging | 8051 | 1468 | 2026-04-06 |
| Slicer | Multi-platform, free open source software for visualization and image computing. | 2401 | 715 | 2026-04-06 |
| torchio | Medical imaging processing for AI applications. | 2381 | 260 | 2026-04-06 |
| MedicalZooPytorch | A pytorch-based deep learning framework for multi-modal 2D/3D medical image segmentation | 1910 | 305 | 2026-03-31 |
| fastMRI | A large-scale dataset of both raw MRI measurements and clinical MRI images. | 1515 | 419 | 2026-04-01 |
| nilearn | Machine learning for NeuroImaging in Python | 1383 | 652 | 2026-04-06 |
...
| SimpleITK | SimpleITK: a layer built on top of the Insight Toolkit (ITK), intended to simplify and facilitate ITK's use in rapid prototyping, education and interpreted languages. | 1053 | 228 | 2026-04-06 |
| medicaltorch | A medical imaging framework for Pytorch | 872 | 129 | 2026-03-23 |
| nipype | Workflows and interfaces for neuroimaging packages | 822 | 543 | 2026-04-06 |
| freesurfer | Neuroimaging analysis and visualization suite | 816 | 285 | 2026-04-06 |
| nibabel | Python package to access a cacophony of neuro-imaging file formats | 771 | 280 | 2026-04-06 |
| SynthSeg | Contrast-agnostic segmentation of MRI scans | 544 | 150 | 2026-03-29 |
...
| mriviewer | MRI Viewer is a high performance web tool for advanced 2-D and 3-D medical visualizations. | 360 | 103 | 2026-04-06 |
...
| mrtrix3 | MRtrix3 provides a set of tools to perform various advanced diffusion MRI analyses, including constrained spherical deconvolution (CSD), probabilistic tractography, track-density imaging, and apparent fibre density | 345 | 197 | 2026-04-03 |
...
| direct | Deep learning framework for MRI reconstruction | 298 | 47 | 2026-04-02 |
| spinalcordtoolbox | Comprehensive and open-source library of analysis tools for MRI of the spinal cord. | 260 | 118 | 2026-04-01 |
...
| KomaMRI.jl | Koma is a Pulseq-compatible framework to efficiently simulate Magnetic Resonance Imaging (MRI) acquisitions. The main focus of this package is to simulate general scenarios that could arise in pulse sequence development. | 194 | 36 | 2026-04-01 |
...
| qsiprep | Preprocessing of diffusion MRI | 178 | 62 | 2026-04-06 |
...
| virtual-scanner | An end-to-end hybrid MR simulator/console | 74 | 22 | 2026-04-01 |
...
| dafne | Dafne (Deep Anatomical Federated Network) is a collaborative platform to annotate MRI images and train machine learning models without your data ever leaving your machine. | 19 | 6 | 2026-04-02 |
