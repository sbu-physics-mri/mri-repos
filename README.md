...
|---|---|---|---|---|
| MONAI | AI Toolkit for Healthcare Imaging | 8649 | 1610 | 2026-09-02 |
| Slicer | Multi-platform, free open source software for visualization and image computing. | 2610 | 778 | 2026-09-02 |
| torchio | Medical imaging processing for AI applications. | 2440 | 275 | 2026-09-02 |
...
| nilearn | Machine learning for NeuroImaging in Python | 1427 | 678 | 2026-09-02 |
...
| SimpleITK | SimpleITK: a layer built on top of the Insight Toolkit (ITK), intended to simplify and facilitate ITK's use in rapid prototyping, education and interpreted languages. | 1084 | 234 | 2026-09-02 |
...
| freesurfer | Neuroimaging analysis and visualization suite | 868 | 299 | 2026-09-03 |
| nipype | Workflows and interfaces for neuroimaging packages | 834 | 539 | 2026-08-25 |
| nibabel | Python package to access a cacophony of neuro-imaging file formats | 790 | 295 | 2026-09-03 |
...
| mriqc | Automated Quality Control and visual reports for Quality Assessment of structural (T1w, T2w) and functional MRI of the brain | 372 | 140 | 2026-09-02 |
...
| PyMVPA | MultiVariate Pattern Analysis in Python | 325 | 135 | 2026-06-16 |
| direct | Deep learning framework for MRI reconstruction | 320 | 50 | 2026-08-29 |
| spinalcordtoolbox | Comprehensive and open-source library of analysis tools for MRI of the spinal cord. | 269 | 120 | 2026-09-02 |
...
| KomaMRI.jl | Koma is a GPU-accelerated, Pulseq-compatible framework for simulating Magnetic Resonance Imaging (MRI) acquisitions. The primary focus of this package is to simulate the wide range of scenarios encountered during pulse sequence development. | 218 | 48 | 2026-09-02 |
...
| gif_your_nifti | How to create fancy GIFs from an MRI brain image | 129 | 35 | 2026-09-03 |
...
| niworkflows | Common workflows for MRI (anatomical, functional, diffusion, etc) | 117 | 57 | 2026-09-02 |
...
| SVRTK | MIRTK based SVR reconstruction | 76 | 9 | 2026-09-02 |
...
| dafne | Dafne (Deep Anatomical Federated Network) is a collaborative platform to annotate MRI images and train machine learning models without your data ever leaving your machine. | 22 | 6 | 2026-09-02 |
