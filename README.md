...
|---|---|---|---|---|
| MONAI | AI Toolkit for Healthcare Imaging | 8584 | 1601 | 2026-08-10 |
| Slicer | Multi-platform, free open source software for visualization and image computing. | 2575 | 767 | 2026-08-10 |
| torchio | Medical imaging processing for AI applications. | 2430 | 274 | 2026-08-05 |
| MedicalZooPytorch | A pytorch-based deep learning framework for multi-modal 2D/3D medical image segmentation | 1917 | 306 | 2026-08-10 |
| fastMRI | A large-scale dataset of both raw MRI measurements and clinical MRI images. | 1534 | 422 | 2026-08-08 |
| nilearn | Machine learning for NeuroImaging in Python | 1423 | 674 | 2026-08-04 |
| medicaldetectiontoolkit | The Medical Detection Toolkit contains 2D + 3D implementations of prevalent object detectors such as Mask R-CNN, Retina Net, Retina U-Net, as well as a training and inference framework focused on dealing with medical images.   | 1353 | 294 | 2026-08-07 |
| SimpleITK | SimpleITK: a layer built on top of the Insight Toolkit (ITK), intended to simplify and facilitate ITK's use in rapid prototyping, education and interpreted languages. | 1083 | 229 | 2026-08-10 |
...
| freesurfer | Neuroimaging analysis and visualization suite | 865 | 295 | 2026-08-11 |
| nipype | Workflows and interfaces for neuroimaging packages | 834 | 539 | 2026-07-28 |
| nibabel | Python package to access a cacophony of neuro-imaging file formats | 784 | 293 | 2026-08-06 |
...
| nipy | Neuroimaging in Python FMRI analysis package | 415 | 146 | 2026-08-06 |
...
| mrtrix3 | MRtrix3 provides a set of tools to perform various advanced diffusion MRI analyses, including constrained spherical deconvolution (CSD), probabilistic tractography, track-density imaging, and apparent fibre density | 351 | 202 | 2026-08-01 |
...
| spinalcordtoolbox | Comprehensive and open-source library of analysis tools for MRI of the spinal cord. | 266 | 121 | 2026-08-10 |
...
| qsiprep | Preprocessing of diffusion MRI | 186 | 64 | 2026-08-08 |
...
| smriprep | Structural MRI PREProcessing (sMRIPrep) workflows for NIPreps (NeuroImaging PREProcessing tools) | 165 | 47 | 2026-08-10 |
...
| DECAES.jl | DEcomposition and Component Analysis of Exponential Signals (DECAES) - a Julia implementation of the UBC Myelin Water Imaging (MWI) toolbox for computing voxelwise T2-distributions of multi spin-echo MRI images. | 39 | 6 | 2026-08-06 |
...
| flow4D | Python code for processing 4D flow dicoms and write velocity profiles for CFD simulations. | 28 | 6 | 2026-08-09 |
