...
|---|---|---|---|---|
| MONAI | AI Toolkit for Healthcare Imaging | 7919 | 1445 | 2026-03-10 |
| torchio | Medical imaging processing for AI applications. | 2369 | 257 | 2026-03-09 |
| Slicer | Multi-platform, free open source software for visualization and image computing. | 2359 | 703 | 2026-03-11 |
| MedicalZooPytorch | A pytorch-based deep learning framework for multi-modal 2D/3D medical image segmentation | 1905 | 305 | 2026-03-10 |
| fastMRI | A large-scale dataset of both raw MRI measurements and clinical MRI images. | 1506 | 417 | 2026-03-05 |
| nilearn | Machine learning for NeuroImaging in Python | 1369 | 648 | 2026-03-10 |
| medicaldetectiontoolkit | The Medical Detection Toolkit contains 2D + 3D implementations of prevalent object detectors such as Mask R-CNN, Retina Net, Retina U-Net, as well as a training and inference framework focused on dealing with medical images.   | 1348 | 293 | 2026-03-10 |
| deepmedic | Efficient Multi-Scale 3D Convolutional Neural Network for Segmentation of 3D Medical Scans | 1057 | 346 | 2026-03-09 |
| SimpleITK | SimpleITK: a layer built on top of the Insight Toolkit (ITK), intended to simplify and facilitate ITK's use in rapid prototyping, education and interpreted languages. | 1047 | 226 | 2026-03-10 |
| medicaltorch | A medical imaging framework for Pytorch | 871 | 128 | 2026-02-25 |
| nipype | Workflows and interfaces for neuroimaging packages | 817 | 542 | 2026-03-06 |
| freesurfer | Neuroimaging analysis and visualization suite | 804 | 281 | 2026-03-09 |
| nibabel | Python package to access a cacophony of neuro-imaging file formats | 768 | 277 | 2026-03-10 |
| SynthSeg | Contrast-agnostic segmentation of MRI scans | 537 | 144 | 2026-03-08 |
| brainchop | Brainchop: In-browser 3D MRI rendering and segmentation | 524 | 62 | 2026-03-07 |
| nipy | Neuroimaging in Python FMRI analysis package | 407 | 147 | 2026-02-03 |
| mriviewer | MRI Viewer is a high performance web tool for advanced 2-D and 3-D medical visualizations. | 360 | 104 | 2026-01-13 |
| bart | BART: Toolbox for Computational Magnetic Resonance Imaging | 359 | 174 | 2026-03-03 |
| mriqc | Automated Quality Control and visual reports for Quality Assessment of structural (T1w, T2w) and functional MRI of the brain | 350 | 136 | 2026-02-27 |
| mrtrix3 | MRtrix3 provides a set of tools to perform various advanced diffusion MRI analyses, including constrained spherical deconvolution (CSD), probabilistic tractography, track-density imaging, and apparent fibre density | 342 | 196 | 2026-03-08 |
| intensity-normalization | Normalize MR image intensities in Python | 338 | 57 | 2026-02-25 |
| PyMVPA | MultiVariate Pattern Analysis in Python | 324 | 137 | 2026-01-19 |
| direct | Deep learning framework for MRI reconstruction | 297 | 46 | 2026-03-05 |
| spinalcordtoolbox | Comprehensive and open-source library of analysis tools for MRI of the spinal cord. | 259 | 115 | 2026-03-03 |
| gadgetron | Gadgetron - Medical Image Reconstruction Framework | 258 | 166 | 2026-03-10 |
| nitime | Timeseries analysis for neuroscience data | 256 | 84 | 2026-03-02 |
| TractSeg | Automatic White Matter Bundle Segmentation | 254 | 79 | 2026-02-27 |
| pypulseq | Pulseq in Python | 193 | 86 | 2026-03-10 |
| brainGraph | Graph theory analysis of brain MRI data | 192 | 54 | 2026-02-22 |
| KomaMRI.jl | Koma is a Pulseq-compatible framework to efficiently simulate Magnetic Resonance Imaging (MRI) acquisitions. The main focus of this package is to simulate general scenarios that could arise in pulse sequence development. | 188 | 33 | 2026-03-06 |
| qsiprep | Preprocessing of diffusion MRI | 178 | 62 | 2026-03-10 |
| clinicadl | Framework for the reproducible processing of neuroimaging data with deep learning methods | 178 | 61 | 2026-03-10 |
| smriprep | Structural MRI PREProcessing (sMRIPrep) workflows for NIPreps (NeuroImaging PREProcessing tools) | 162 | 46 | 2026-03-10 |
| NiftyMIC | NiftyMIC is a research-focused toolkit for motion correction and volumetric image reconstruction of 2D ultra-fast MRI. | 160 | 39 | 2026-02-25 |
| mritopng | A simple python module to make it easy to batch convert DICOM files to PNG images. | 146 | 52 | 2025-10-31 |
| pydeface | defacing utility for MRI images | 136 | 44 | 2026-03-05 |
...
| ismrmrd | ISMRM Raw Data Format | 121 | 94 | 2026-03-10 |
| RadQy | RadQy is a quality assurance and checking tool for quantitative assessment of magnetic resonance imaging (MRI) and computed tomography (CT) data. | 115 | 37 | 2026-03-10 |
| niworkflows | Common workflows for MRI (anatomical, functional, diffusion, etc) | 108 | 57 | 2026-03-10 |
...
| NeSVoR | NeSVoR is a package for GPU-accelerated slice-to-volume reconstruction. | 101 | 23 | 2026-02-25 |
| BraTS-Toolkit | Code to preprocess, segment, and fuse glioma MRI scans based on the BraTS Toolkit manuscript. | 100 | 14 | 2026-03-07 |
| MRIReco.jl | Julia Package for MRI Reconstruction | 97 | 23 | 2026-03-04 |
...
| SIRF | Main repository for the CCP SynerBI software | 69 | 29 | 2026-02-22 |
| SVRTK | MIRTK based SVR reconstruction | 66 | 8 | 2026-02-25 |
| QUIT | A set of tools for processing Quantitative MR Images | 63 | 21 | 2026-02-23 |
| tensorflow-mri | A Library of TensorFlow Operators for Computational MRI | 46 | 6 | 2026-02-25 |
...
| hazen | Quality assurance framework for Magnetic Resonance Imaging | 29 | 13 | 2026-03-10 |
| disimpy | Massively parallel Monte Carlo diffusion MR simulator written in Python. | 29 | 9 | 2026-02-18 |
| gropt | A toolbox for MRI gradient design | 29 | 17 | 2026-03-03 |
| MriResearchTools.jl | Specialized tools for MRI | 26 | 8 | 2026-01-08 |
| flow4D | Python code for processing 4D flow dicoms and write velocity profiles for CFD simulations. | 25 | 7 | 2026-01-20 |
| nlsam | The reference implementation for the Non Local Spatial and Angular Matching (NLSAM) denoising algorithm for diffusion MRI | 25 | 10 | 2026-02-11 |
...
| dafne | Dafne (Deep Anatomical Federated Network) is a collaborative platform to annotate MRI images and train machine learning models without your data ever leaving your machine. | 19 | 6 | 2026-03-10 |
...
| eptlib | EPTlib - An open-source, extensible C++ library of electric properties tomography methods | 17 | 2 | 2026-02-25 |
